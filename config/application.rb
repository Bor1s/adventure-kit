...
module PlayhardCore
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/app/presenters #{config.root}/app/serializers #{config.root}/app/services #{config.root}/app/decorators #{config.root}/lib #{config.root}/lib/providers)
